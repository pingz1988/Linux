...
| lsof 命令 | 查看系统打开的文件，lsof -c -p 1234，显示进程号1234打开的文件， lsof /filepath/file，查看打开该文件的进程； lsof +d /usr/local/ 显示目录下被进程开启的文件；lsof -i[46] [protocol][@hostname|hostaddr][:service|port] |
