...
sub read_repo_info {
	...
	my $git_archive_commit = '7db1feb42ce944e335b42d73f2aaae7464493800';
	my @git_refs = split(/, /, 'HEAD, tag: wireshark-3.4.5, tag: v3.4.5, origin/release-3.4, refs/pipelines/290114482');
